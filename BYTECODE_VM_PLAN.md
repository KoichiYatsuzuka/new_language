...
⇒ **着手可能なのは #77〜#82 ＋ 別レーン 3 件**（全件が前提なし。#75・#76 は完了）。
...
> **✅ 全ゲート緑（2026-08-24・#76 完了時に自分で走らせて確認）**
...
> [ab_bench_modes.ps1](ab_bench_modes.ps1) は**負の対照つきで**読む（cdll のノイズ帯は実測 **±3.5%**・#76）／
...
1. ⚠⚠ **#77〜#82（第 3 弾）が起票済み・全件が前提なし**（**#75・#76 は完了**）。実バグの温床は **#77**。
...
> （第 3 弾。A群＝実バグの温床 75〜77／B群＝逐語重複 78〜80／C群＝ドリフト強制の穴 81・82。**75・76 は完了**。
