...
⇒ **着手可能なのは #79〜#82 ＋ 別レーン 3 件**（全件が前提なし。**A 群 75〜77 と 78・83 は完了**）。
...
> **✅ 全ゲート緑（2026-08-25・#78 完了時に自分で走らせて確認）**
...
1. ⚠⚠ **#79〜#82（第 3 弾）が起票済み・全件が前提なし**（**A 群 75〜77 ＋ 78・83 は完了**）。残りは B 群 79・80 と C 群 81・82。
...
> （第 3 弾。A群＝実バグの温床 75〜77／B群＝逐語重複 78〜80／C群＝ドリフト強制の穴 81・82／**83 は #76 からの派生**。**75〜78 と 83 は完了**。
