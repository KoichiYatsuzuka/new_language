...
//
// The generated code receives a `HvCallbacks` struct pointer via `hv_init(cb)`
...
const MODULE_HEADER: &str = r#"// Auto-generated by Havakyrie compiler — do not edit.
...
// ── HvCallbacks struct (must match interpreter::native_api::HvCallbacks) ─────
#[repr(C)]
struct HvCallbacks {
...
#[no_mangle]
pub unsafe extern "C" fn hv_init(cb: *const HvCallbacks) {
    CB = cb;
}
