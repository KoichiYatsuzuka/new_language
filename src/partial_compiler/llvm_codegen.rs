...
; HvCallbacks: 38 function-pointer fields (opaque ptr, LLVM 15+)
%HvCallbacks = type { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr }
...
struct GenCtx<'a> {
    ...
    // Populated at function entry; used by gen_call to avoid the HvCallbacks GEP chain.
...
impl<'a> GenCtx<'a> {
    ...
    fn gen_call(&mut self, func: &Expr, args: &[CallArg]) -> String {
        ...
        // Loads one local ptr instead of the three-instruction HvCallbacks GEP chain,
    ...
    fn emit_fn(&mut self, name: &str, params: &[Param], ret_ann: Option<&str>, body: &[Stmt]) {
        ...
        // Called once at function entry so the hot path avoids the HvCallbacks GEP chain.
        for (i, p) in params.iter().enumerate() {
            let Some(ann) = &p.type_ann else { continue };
