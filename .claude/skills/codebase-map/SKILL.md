...
vscode-extension/  (8 files, 2522 lines; src/ + syntaxes/ only)
  src/
    debug_runner.ts (362)
    extension.ts (267)
    frontend.ts (188)
...
scripts/  (検証・計測スクリプト。何をいつ走らせるかは CLAUDE.md)
  ...
  scan_examples.ps1 (81)
  stale_doc_refs.ps1 (131)
  syntax_cov.ps1 (215)
  test_build_gate.ps1 (53)
  tw_stats.ps1 (105)
