...
scripts/  (検証・計測スクリプト。何をいつ走らせるかは CLAUDE.md)
  ...
  compare_bytecode.ps1 (132)
  compare_import_paths.ps1 (135)
  compare_outputs.ps1 (137)
  compare_python_impl.ps1 (358)
...
(repo root)
  ...
  README.md (317)
```
_Generated 2026-09-17 by generate-codebase-map.ps1_
<!-- END AUTO-TREE -->
